...
import org.droidtv.tv.dlna.IUPnPTransform;
...
public class UPnPTransform implements Parcelable, IUPnPTransform
{
	 ...
	 */
	public UPnPTransform(String _Name, String _FriendlyName, String _unit, int _MinValue, int _MaxValue, int _StepSize, int _InactiveValue, int _Error)
	{
	...
	public void setStringValue(int id, String value)
	{
		switch(id)
		{
			case TRANSFORM_NAME : mName = value;
			                      if(mName == null){
		                              mName = "";
		                          }
								  break;
			case TRANSFORM_FRIENDLY_NAME : mFriendlyName = value;
									       if(mFriendlyName == null){
		                                       mFriendlyName = "";
		                                   }
								           break;
			case TRANSFORM_UNIT : mUnit = value;
			                            if(mUnit == null){
                                            mUnit = "";
		                                }
										break;
	...
	public String getStringValue(int id)
	{
		...
		switch(id)
		{
			case TRANSFORM_NAME : value = mName;
								break;
			case TRANSFORM_FRIENDLY_NAME : value = mFriendlyName;
									break;
            case TRANSFORM_UNIT : value = mUnit;
			                      break;
			default:
				Log.v(TAG,"setStringValue default case");
				value="";
		...
		public void setIntValue(int id,int value)
	{
		switch(id)
		{
			case MINIMUM_VALUE:  mMinVal = value;
								break;
			case MAXIMUM_VALUE: mMaxVal = value;
								break;
			case STEP_SIZE:		mStepSize = value;
								break;
			case INACTIVE_VALUE:mInActiveVal = value;
								break;
			case ERROR:			mError = value;
								break;
			default:
	...
	public int getIntValue(int id)
	{
		...
		switch(id)
		{
			case MINIMUM_VALUE: value = mMinVal;
								break;
			case MAXIMUM_VALUE: value = mMaxVal;
								break;
			case STEP_SIZE:		value = mStepSize;
								break;
			case INACTIVE_VALUE:value = mInActiveVal;
								break;
			case ERROR:			value = mError;
								break;
			default:
			    Log.v(TAG,"Default case");
				break;
