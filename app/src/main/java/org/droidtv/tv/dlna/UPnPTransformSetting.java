...
import org.droidtv.tv.dlna.IUPnPTransformSetting;

/**
 * UPnP Transforms settings
 *
 * class that can describes RendererSide Content Transforms settings
 * e.g. the current or wanted values of an transform
 * 
...
public class UPnPTransformSetting implements Parcelable, IUPnPTransformSetting
{
	...
	public void setStringValue(int id, String value)
	{
		...
		switch(id)
		{
			case TRANSFORM_SETTING_NAME : mName = value;
								break;
			case TRANSFORM_SETTING_VALUE : mValue = value;
									break;
			default:
	...
	public String getStringValue(int id)
	{
		...
		switch(id)
		{
			case TRANSFORM_SETTING_NAME : value = mName;
								break;
			case TRANSFORM_SETTING_VALUE : value = mValue;
									break;
			default:
