...
public interface IUPnPAVObject {
	 ...
	 *            ID of the information
	 * @param index
	 *            index of the ID from were data to be fetched
	 ...
	 * 
	 * @param id
	 *            ID of the resource value
	 * @param resNum
	 *            which resource to be used
	 * @param value
	 *            value to be set
	 */
	public void setResourceValue(final int id, final int resNum,
                                 final String value);
	 ...
	 *            ID of the resource extension
	 * @param compGroupID
	 *            ID of component group
	 * @return resource extension component group object
	 */
	public ComponentGroup getResourceExtComponentGroup(final String resExtID,
                                                       final String compGroupID);
	 ...
	 * @param compGroupID
	 *            ID of component group
	 * @param isCompGroupReq
	 *            to check if component group is required
	 */
	public void addResourceExtComponentGroup(final String resExtID,
                                             final String compGroupID, final int isCompGroupReq);
	 ...
	 * @param compExtType
	 *            extension type of component
	 * @param compResProtocolInfo
	 *            protocol information of component
	 * @param compResURL
	 *            resource URL of component
	 */
	public void addResourceExtComponent(final String resExtID,
                                        final String compGroupID, final String compID,
                                        final String compClass, final String compMimeType,
                                        final String compExtType, final String compResProtocolInfo,
                                        final String compResURL);
	...
	public interface IComponentGroup {
		 ...
		 *            resource URL of component
		 */
		public void addComponent(final String compID, final String compClass,
                                 final String compMimeType, final String compExtType,
	...
	public interface IResource {
		 ...
		 * 
		 * @param id
		 *            value of resource protocol information
		 */
		 ...
		 * 
		 * @param id
		 *            value of resource x co-ordinate
		 */
		 ...
		 * 
		 * @param id
		 *            value of resource y co-ordinate
		 */
		 ...
		 * 
		 * @param id
		 *            value of resource number of channel
		 */
		 ...
		 * 
		 * @param id
		 *            value of resource bit rate sample
		 */
		 ...
		 * 
		 * @param id
		 *            value of resource sample frequency
		 */
